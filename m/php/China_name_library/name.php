<?php
$rare = "m".DIRECTORY_SEPARATOR."php".DIRECTORY_SEPARATOR."China_name_library".DIRECTORY_SEPARATOR."name_lib";
$chinese_name_lib_path =  $_SERVER['DOCUMENT_ROOT'].DIRECTORY_SEPARATOR.$rare;
$last_name = [
